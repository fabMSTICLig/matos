    ...
    <div class="container-fluid"><a class="navbar-brand" href="/"><strong>{{ title }}</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item" role="presentation"><router-link class="nav-link" active-class="active" exact :to="{ name: 'login' }">Home</router-link></li>
                <li class="nav-item" role="presentation"><router-link class="nav-link" active-class="active" exact :to="{ name: 'login' }">Entités</router-link></li>
            ...
            <ul v-if="isAuthenticated" class="nav navbar-nav">
                <li class="nav-item" role="presentation"><router-link class="nav-link" active-class="active" exact :to="{ name: 'login' }" v-text="authUser.username"  ></router-link></li>
