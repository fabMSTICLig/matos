<template>
  <header class="header" role="banner">
    <div class="section">
      <div class="menu_top d-lg-block">
          <div class="container-fluid">
              <div class="row">
                  <div class="col-3 col-md-3 col-lg-4 col-xl-6">
                      <a class="btn btn-back" href="https://www.univ-grenoble-alpes.fr/" role="button">
      ...
      <div id="block-uga-theme-branding"> 
          <div class="container-fluid">
              <div class="row h-100 position-relative">
                  <div class="col-6 col-md-4 col-lg-3 main-logo">
                      <a class="site-logo" href="/">
                          <img src="../../public/LogoFalabMASTIC.png"/>
                      </a>
                  </div>
                  <div class="site-name-wrapper col-6 col-md-5 col-lg-6 col-xl-6">
                      <p class="site-name"> MATOS </p>
                  </div>
                  ...
                  <div class="col-3 d-none d-md-flex d-lg-none">
                      <div v-if="isAuthenticated" class="liste-secondaire">
                        <router-link
                          v-if="isAuthenticated"
                          class="btn btn-primary"
                      ...
                      <div v-else id="navcol-1" class="liste-secondaire" :class="collapsed">
        ...
        <div class="container-fluid">
          ...
          <div id="navcol-1" :class="collapsed">
            <ul class="nav navbar-nav">
              ...
              <Dropdown v-if="isManager && myEntities.length > 1 " :items="myEntities" label="Gestion entités" class="nav-item drop-align-rect" is-nav />
              <router-link
              ...
              <Dropdown v-if="isAdmin" :items="adminroutes" label="Admin" class="nav-item drop-align-rect" is-nav />
            </ul>
          </div>
        </div>
      </nav>
...
<style>
  @import url("http://fonts.googleapis.com/css?family=Calistoga|Open+Sans:300italic,600italic,400,300,600,700,800");
  @import "../assets/CSS/header-screen.css";
</style>
