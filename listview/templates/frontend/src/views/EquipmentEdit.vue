<template>
        <form action="" @submit="updateEquipment(equipment)" v-if="equipment">
            ...
            <div class="form-group">
                <textarea v-model="equipment.description" placeholder="Description" class="form-control" />
            </div>
             <div class="form-group">
                <input type="number" v-model="equipment.location" placeholder="Organisation" class="form-control">
            </div>
             <div class="form-group">
                <categorie v-bind:family="equipment.family" v-if="equipment.family"></categorie>
                <input type="number" v-model="equipment.family" placeholder="Categorie" class="form-control">
            </div>
            <div class="form-group">
                <button class="btn btn-block btn-primary" @click.prevent="updateEquipment(equipment)">Submit
                </button>
            </div>
        </form>
    </template>
  ...
  computed: {
    ...
    equipment() {
      console.log('equipement')
        return this.equipments.find(equipement => equipement.id == this.$route.params.id) || {}
    },
    ...mapGetters([
      'equipments'
    ]),
