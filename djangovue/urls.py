...
from api.views import sample_api, signup_success, productListViewSet, productInstanceListView, index, organizationListView, organizationTypeListView
...
router.register(r'api/organizationtypes', organizationTypeListView)
